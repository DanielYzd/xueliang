<template>
  <div>
    ...
    >
      <!-- selection选择框 -->
      <el-table-column v-if="tableoptions.mutiSelect" type="selection" style="width:50px" align="center"> </el-table-column>
      <!-- 序号 -->
      <el-table-column
...
export default {
  ...
  methods: {
    ...
    indexMethod(index) {
      if (this.pagination) {
        return index + 1 + (this.pagination.pageNum - 1) * this.pagination.numPerPage
      } else {
        return index + 1
      }
    },
